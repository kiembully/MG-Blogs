  ...
  return (
    <AuthenticationPagesLayout>
      ...
      <form className="relative w-96 flex flex-col item-start justify-start mb-28">
        ...
        <p className="mt-8">
          For security purposes, we do NOT store your password. So rest assured
          that we will never send your password via email.
        </p>
        <p className="mt-8 font-medium">Email</p>
        <input
          type="email"
          className="mt-4 h-12 w-full bg-neutral-100 outline-none pl-4"
        />
        <button
          type="button"
          className="mt-8 h-10 w-full bg-primary-500 text-white"
        >
          Send Reset Instructions
        </button>
        <a
          href="#"
          className="mt-4 mx-auto text-primary-500 underline underline-offset-2"
        >
