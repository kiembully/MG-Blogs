  ...
  const renderActiveUserMenu = (): JSX.Element => {
    return (
      <>
        <button
          type='button'
          className='h-10 w-10 rounded-md bg-neutral-100 flex items-center justify-center lg:hidden'
        >
          <img alt='search icon' src='./icons/search-icon.png' className='h-md' />
        </button>
        <button
          type='button'
          className='h-10 w-10 rounded-md bg-neutral-100 flex items-center justify-center'
        >
  ...
  const renderDefaultUserMenu = (): JSX.Element => {
    return (
      <>
        <a
          href='/login'
          className='rounded-md bg-white px-4 py-3 text-primary-500 text-lg leading-[normal]'
        >
          Login
        </a>
        <a
          href='/signup'
          className='rounded-md bg-primary-500 px-4 py-3 text-[white] text-lg leading-[normal]'
        >
          Signup
        </a>
      </>
